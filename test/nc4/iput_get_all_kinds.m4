                ...
                double     *rbuf)
{
    ...
    err = ncmpi_iget_var1_double(ncid, var1_id, &start1, rbuf, NULL); CHECK_ERR

    err = ncmpi_iput_vara_double(ncid, vara_id, start, count, buf, NULL); CHECK_ERR
    err = ncmpi_iget_vara_double(ncid, vara_id, start, count, rbuf, NULL); CHECK_ERR

    err = ncmpi_iput_varn_double(ncid, vara_id, rank & 1, &start, &count, buf, NULL); CHECK_ERR
    err = ncmpi_iget_varn_double(ncid, vara_id, rank & 1, &start, &count, rbuf, NULL); CHECK_ERR

    err = ncmpi_iput_vars_double(ncid, vars_id, startS, countS, stride, buf, NULL);
    CHECK_ERR
    err = ncmpi_iget_vars_double(ncid, vars_id, startS, countS, stride, rbuf, NULL);
    CHECK_ERR

    err = ncmpi_iput_varm_double(ncid, varm_id, startM, countM, NULL, imap, buf, NULL);
    CHECK_ERR
    err = ncmpi_iget_varm_double(ncid, varm_id, startM, countM, NULL, imap, rbuf, NULL);
    CHECK_ERR
...
`dnl
    ...
    _CAT(`nerrs += blocking_iput_',itype)'`(rank, ncid, dimids, start, count,
